...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b88458, const void *arg_0xb7b885f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b398c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79e3840), 
int (*key_eq_fn)(void *arg_0xb79e3c88, void *arg_0xb79e3e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78b29b8, int arg_0xb78b2b10);
static double RandomUniform(void );
...
static const char *randomkeys[20] = { "P3N0vLZMfz3i53vdrl7J", 
...
typedef TMilli ProjectC$ChildTimer$precision_tag;
typedef child_status ProjectC$FakeSensor$val_t;
typedef TMilli ProjectC$TimerPairing$precision_tag;
typedef TMilli ProjectC$ParentTimer$precision_tag;
enum AMQueueP$__nesc_unnamed4328 {
  AMQueueP$NUM_CLIENTS = 1U
};
typedef uint16_t RandomMlcgC$SeedInit$parameter;
typedef child_status /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
static void ProjectC$ChildTimer$fired(void );
# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static void ProjectC$AMControl$startDone(error_t error);
#line 138
static void ProjectC$AMControl$stopDone(error_t error);
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void ProjectC$TimerPairing$fired(void );
#line 83
static void ProjectC$ParentTimer$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone$runTask(void );
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void ProjectC$ChildTimer$startPeriodic(uint32_t dt);
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t ProjectC$AMControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
message_t * msg);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void ProjectC$TimerPairing$startPeriodic(uint32_t dt);
#line 78
static void ProjectC$TimerPairing$stop(void );
#line 73
static void ProjectC$ParentTimer$startOneShot(uint32_t dt);
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
...
am_addr_t ProjectC$address_paired_device[1000];
am_addr_t ProjectC$destination[1000];
uint16_t ProjectC$mode[1000];

child_status ProjectC$actual_status[1000];
child_status ProjectC$last_status[1000];

static void ProjectC$send_pairing(void );
static void ProjectC$send_INFO_msg(void );
...
static inline void ProjectC$AMControl$startDone(error_t err);
...
static inline void ProjectC$AMControl$stopDone(error_t err);

static inline void ProjectC$TimerPairing$fired(void );
#line 75
static inline void ProjectC$ChildTimer$fired(void );




static inline void ProjectC$ParentTimer$fired(void );





static void ProjectC$AMSend$sendDone(message_t *buffer, error_t error);
#line 125
static void ProjectC$send_pairing(void );
#line 138
static void ProjectC$send_INFO_msg(void );
#line 158
static inline message_t *ProjectC$Receive$receive(message_t *buffer, void *payload, uint8_t length);
#line 197
static inline void ProjectC$FakeSensor$readDone(error_t result, child_status status);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
#line 46
static uint32_t /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand32(void );
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone$postTask(void );
# 12 "FakeSensorP.nc"
enum /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$__nesc_unnamed4336 {
#line 12
  FakeSensorP$0$readDone = 5U
};
#line 12
typedef int /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$__nesc_sillytask_readDone[/*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone];
...
static inline void /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone$runTask(void );
# 53 "/opt/tinyos-main-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void ProjectC$ParentTimer$startOneShot(uint32_t dt){
#line 73
...
inline static void ProjectC$TimerPairing$stop(void ){
#line 78
...
#line 160
  sim_log_debug(167U, "Receive", "Message has been received from node %hhu at time %s\n", ProjectC$AMPacket$source(buffer), sim_time_string());
  sim_log_debug(168U, "Receive", "Payload -> type: %hu, data: %s\n", __nesc_ntoh_uint8(msg->msg_type.nxdata), msg->data);

  ProjectC$destination[sim_node()] = ProjectC$AMPacket$destination(buffer);


  if (ProjectC$destination[sim_node()] == AM_BROADCAST_ADDR && ProjectC$mode[sim_node()] == 0 && strcmp(msg->data, randomkeys[TOS_NODE_ID / 2]) == 0) {
      ProjectC$address_paired_device[sim_node()] = ProjectC$AMPacket$source(buffer);
      ProjectC$mode[sim_node()] = 1;
      sim_log_debug(169U, "Receive", "Message for the PAIRING PHASE --> Address: %hhu\n\n", ProjectC$address_paired_device[sim_node()]);
      ProjectC$send_pairing();
    }
  else {
    if (ProjectC$destination[sim_node()] == TOS_NODE_ID) {
        if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == 1) {
            sim_log_debug(170U, "Receive", "Message for PAIRING PHASE has been received\n\n");
            ProjectC$TimerPairing$stop();
          }
        else {
          if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == 2) {
              sim_log_debug(171U, "Receive", "INFO Message received\n");
              sim_log_debug(172U, "OperationalMode", "Position X: %hhu, Y: %hhu\n", __nesc_ntoh_uint16(msg->X.nxdata), __nesc_ntoh_uint16(msg->Y.nxdata));
              sim_log_debug(173U, "OperationalMode", "Child Status: %s\n\n\n", msg->data);
              ProjectC$last_status[sim_node()].X = __nesc_ntoh_uint16(msg->X.nxdata);
              ProjectC$last_status[sim_node()].Y = __nesc_ntoh_uint16(msg->Y.nxdata);
              ProjectC$ParentTimer$startOneShot(60000);

              if (strcmp(msg->data, "FALLING") == 0) {
                  sim_log_debug(174U, "OperationalMode", "ALERT: FALLING\n");
                  sim_log_debug(175U, "OperationalMode", "Position of the child: X: %hhu, Y: %hhu\n\n\n", __nesc_ntoh_uint16(msg->X.nxdata), __nesc_ntoh_uint16(msg->Y.nxdata));
                }
            }
          }
      }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74cf2b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74cf2b0, addr, msg, len);
#line 80
...
#line 53
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void ProjectC$ChildTimer$startPeriodic(uint32_t dt){
#line 64
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t ProjectC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void ProjectC$TimerPairing$startPeriodic(uint32_t dt){
#line 64
...
{
  if (err == SUCCESS) {
      sim_log_debug(149U, "Bracelet", "Bracelet Sensor device is ready\n");
      sim_log_debug(150U, "Pairing Phase", "Pairing phase started\n\n");

      ProjectC$TimerPairing$startPeriodic(1000);
    }
  else 
#line 51
    {
      ProjectC$AMControl$start();
    }
}
...
#line 113
  ProjectC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  ProjectC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74d08a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74d08a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74d08a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(/*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone);
#line 67
...
#line 15
{
  /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone$postTask();
  return SUCCESS;
}
...
{
  if (result == SUCCESS) {
      ProjectC$actual_status[sim_node()] = status;
      sim_log_debug(176U, "ChildSensor", "Child Status: %s\n", ProjectC$actual_status[sim_node()].status);
      sim_log_debug(177U, "ChildSensor", "Position X: %hhu, Y: %hhu\n", ProjectC$actual_status[sim_node()].X, ProjectC$actual_status[sim_node()].Y);
      ProjectC$send_INFO_msg();
    }
  else {
...
#line 52
#line 46
inline static uint32_t /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand32(void ){
#line 46
  unsigned int __nesc_result;
#line 46
...
#line 21
{
  ...
  int choice = /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand32() % 10;
  ...
  status.X = /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16();
  status.Y = /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16();

  /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, status);
}
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb780e650){
#line 75
  switch (arg_0xb780e650) {
#line 75
...
#line 75
      break;
#line 75
    case /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone:
#line 75
      /*ProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone$runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb780e650);
#line 75
      break;
#line 75
    }
...
#line 58
{
  ...
  sim_log_debug(151U, "TimerPairing", "TimerPairing: timer fired at time %s\n\n", sim_time_string());

  if (!ProjectC$locked[sim_node()]) {
      msg_t *msg = (msg_t *)ProjectC$Packet$getPayload(&ProjectC$packet[sim_node()], sizeof(msg_t ));
...
#line 64
      ...
      if (ProjectC$AMSend$send(AM_BROADCAST_ADDR, &ProjectC$packet[sim_node()], sizeof msg) == SUCCESS) {
          sim_log_debug(152U, "Bracelet", "Bracelet Sensor is sending pairing packet -> key = %s\n\n", randomkeys[TOS_NODE_ID / 2]);
...
#line 75
{
  sim_log_debug(153U, "ChildTimer", "ChildTimer: timer fired at time %s\n", sim_time_string());
  ProjectC$FakeSensor$read();
}
...
#line 80
{
  sim_log_debug(154U, "ParentTimer", "ParentTimer: timer fired at time %s\n", sim_time_string());
  sim_log_debug(155U, "ParentTimer", "ALERT: MISSING\n");
  sim_log_debug(156U, "ParentTimer", "Last location X: %hhu, Y: %hhu\n\n", ProjectC$last_status[sim_node()].X, ProjectC$last_status[sim_node()].Y);
}
...
#line 83
    case 0U:
#line 83
      ProjectC$TimerPairing$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      ProjectC$ChildTimer$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      ProjectC$ParentTimer$fired();
#line 83
      break;
#line 83
    default:
...
#line 128
      __nesc_hton_uint8(msg->msg_type.nxdata, ProjectC$mode[sim_node()]);
      strcpy(msg->data, randomkeys[TOS_NODE_ID / 2]);
      ProjectC$PacketAcknowledgements$requestAck(&ProjectC$packet[sim_node()]);
      if (ProjectC$AMSend$send(ProjectC$address_paired_device[sim_node()], &ProjectC$packet[sim_node()], sizeof(msg_t )) == SUCCESS) {
          sim_log_debug(165U, "Bracelet", "Bracelet Sensor: sending pairing ACK to node %hhu\n\n", ProjectC$address_paired_device[sim_node()]);
          ProjectC$locked[sim_node()] = TRUE;
        }
    }
}
...
#line 86
{
  if (&ProjectC$packet[sim_node()] == buffer && error == SUCCESS) {
      sim_log_debug(157U, "AMSend", "AMSend: Packet is sent\n");
      ProjectC$locked[sim_node()] = FALSE;

      if (ProjectC$mode[sim_node()] == 1) {
          if (ProjectC$PacketAcknowledgements$wasAcked(buffer)) {
              ProjectC$mode[sim_node()] = 2;
              sim_log_debug(158U, "AMSend", "AMSend ACK received at time %s\n", sim_time_string());
              sim_log_debug(159U, "Pairing Phase", "Pairing Phase -> pairing has been completed for node %hhu\n\n", ProjectC$address_paired_device[sim_node()]);

              if (TOS_NODE_ID % 2 == 0) {
                  sim_log_debug(160U, "OperationalMode", "Parent bracelet has been activated\n\n");
                  ProjectC$ParentTimer$startOneShot(60000);
                }
              else {
                  sim_log_debug(161U, "OperationalMode", "Child bracelet has been activated\n\n");
                  ProjectC$ChildTimer$startPeriodic(10000);
                }
            }
          else {
              sim_log_debug(162U, "AMSend", "Pairing FAILED-> ACK not received at time %s\n", sim_time_string());
              ProjectC$send_pairing();
            }
        }
      else {
        if (ProjectC$mode[sim_node()] == 2) {
            if (ProjectC$PacketAcknowledgements$wasAcked(buffer)) {
                sim_log_debug(163U, "AMSend", "OperationalMode SUCCESS-> ACK received at time %s\n\n", sim_time_string());
              }
            else {
                sim_log_debug(164U, "AMSend", "OperationalMode FAILED-> ACK not received at time %s\n\n", sim_time_string());
                ProjectC$send_INFO_msg();
              }
          }
        }
...
#line 141
      __nesc_hton_uint8(msg->msg_type.nxdata, ProjectC$mode[sim_node()]);
      __nesc_hton_uint16(msg->X.nxdata, ProjectC$actual_status[sim_node()].X);
      __nesc_hton_uint16(msg->Y.nxdata, ProjectC$actual_status[sim_node()].Y);

      strcpy(msg->data, ProjectC$actual_status[sim_node()].status);

      ProjectC$PacketAcknowledgements$requestAck(&ProjectC$packet[sim_node()]);

      if (ProjectC$AMSend$send(ProjectC$address_paired_device[sim_node()], &ProjectC$packet[sim_node()], sizeof(msg_t )) == SUCCESS) {
          sim_log_debug(166U, "Bracelet", "Bracelet Sensor is sending INFO to node %hhu\n\n", ProjectC$address_paired_device[sim_node()]);
          ProjectC$locked[sim_node()] = TRUE;
        }
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "ProjectC$address_paired_device"))
  {
    *addr = (uintptr_t)&ProjectC$address_paired_device[__nesc_mote];
    *size = sizeof(ProjectC$address_paired_device[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ProjectC$destination"))
  {
    *addr = (uintptr_t)&ProjectC$destination[__nesc_mote];
    *size = sizeof(ProjectC$destination[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ProjectC$mode"))
  {
    *addr = (uintptr_t)&ProjectC$mode[__nesc_mote];
    *size = sizeof(ProjectC$mode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ProjectC$actual_status"))
  {
    *addr = (uintptr_t)&ProjectC$actual_status[__nesc_mote];
    *size = sizeof(ProjectC$actual_status[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ProjectC$last_status"))
  {
    *addr = (uintptr_t)&ProjectC$last_status[__nesc_mote];
    *size = sizeof(ProjectC$last_status[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&ProjectC$address_paired_device[__nesc_mote], 0, sizeof ProjectC$address_paired_device[__nesc_mote]);
  memset((void *)&ProjectC$destination[__nesc_mote], 0, sizeof ProjectC$destination[__nesc_mote]);
  memset((void *)&ProjectC$mode[__nesc_mote], 0, sizeof ProjectC$mode[__nesc_mote]);
  memset((void *)&ProjectC$actual_status[__nesc_mote], 0, sizeof ProjectC$actual_status[__nesc_mote]);
  memset((void *)&ProjectC$last_status[__nesc_mote], 0, sizeof ProjectC$last_status[__nesc_mote]);
